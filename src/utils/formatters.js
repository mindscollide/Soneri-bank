...
export const formatCurrencyInput = (value) => {
  ...
  // Cap at 5 digits total (max: 999.99)
  cleanVal = cleanVal.slice(0, 5);

  // Format with decimal once we have more than 3 digits
  if (cleanVal.length > 3) {
    const integerPart = cleanVal.slice(0, 3);
    const decimalPart = cleanVal.slice(3, 5);
